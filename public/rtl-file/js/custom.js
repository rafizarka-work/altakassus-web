(function($) {
    ...
    $(window).on("load", function() {
        ...
        if (filterizr_container.length) {
            ...
            console.log("Portfolio items found:", filterizr_container.find('.filtr-item').length);
            filterizr_container.find('.filtr-item').each(function(index) {
                console.log("Item " + index + " category:", $(this).attr('data-category'));
            });
